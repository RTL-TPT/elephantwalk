...
var g_mapsetdata = [
	...
	{ //mapset 8
		...
		"clues": [ //[left,top,width,height,clue]
			[3,6,607,295,"ocean"],
			[311,84,97,77,"building"],
			[429,23,149,85,"lake"],
			[517,373,144,30,"lake"],
			[514,783,149,90,"forest"],
			[219,844,93,68,"building"],
			[98,652,153,96,"forest"],
			[291,469,480,219,"stream"]
		]
	},
	{ //mapset 9
		"elephant": { //y_x_direction: [left,top,width,height]
		...
		"clues": [ //[left,top,width,height,clue]
			[439,47,67,62,"park"],
			[5,4,289,386,"stream"],
			[532,329,158,92,"forest"],
			[422,478,145,93,"lake"],
			[224,518,92,68,"building"],
			[90,474,156,91,"forest"],
			[119,672,70,69,"park"],
			[219,772,180,404,"road"]
		]
	},
	{ //mapset 10
		"elephant": { //y_x_direction: [left,top,width,height]
